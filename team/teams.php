...
.team-video {
  ...
  overflow: hidden; /* Ensure video stays within rounded borders */
}
...
<body>
  ...
  <nav>
    ...
    <ul class="navbar">
        <li><a href="/Cricket/index.php">Home</a></li>
        <li><a href="#matches">Matches</a></li>
        <li><a href="#news">News</a></li>
        <li><a href="/Cricket/rankings.php">Rankings</a></li>
        <li class="dropdown">
            <a href="#login">Login</a>
            <ul class="dropdown-content">
                <li><a href="/Cricket/team-login.php">Team Login</a></li>
                <li><a href="/Cricket/admin-login.php">Admin Login</a></li>
                <li><a href="/Cricket/organizer-login.php">Organizer Login</a></li>
            </ul>
        </li>
    </ul>
  </nav>
...
dots[slideIndex].className += " active";
  ...
  <script>
    // Add navigation toggle function
    function toggleNav() {
