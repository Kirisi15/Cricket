...
--
-- Host: localhost
-- Generation Time: Nov 08, 2024 at 08:33 AM
...
(20, '10', 'Team D', 'Team E', '2024-10-30', '18:00:00', 'Stadium J', 210, 205, 'Team A');
...
CREATE TABLE `player` (
  ...
  `playerImage` varchar(20) DEFAULT NULL,
...
--
ALTER TABLE `matches`
  MODIFY `matchId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
